...
const SQLiteWasmDatabaseFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_sqlitewasmdatabase_free(ptr >>> 0, 1));

export class SQLiteWasmDatabase {

    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(SQLiteWasmDatabase.prototype);
        obj.__wbg_ptr = ptr;
        SQLiteWasmDatabaseFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        SQLiteWasmDatabaseFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_sqlitewasmdatabase_free(ptr, 0);
    }
    /**
     * Create a new database connection with fully embedded worker
     * @returns {WasmEncodedResult<SQLiteWasmDatabase>}
     */
    static new() {
        const ret = wasm.sqlitewasmdatabase_new();
        return ret;
    }
    /**
     * Execute a SQL query
    ...
    query(sql) {
        ...
        const ret = wasm.sqlitewasmdatabase_query(this.__wbg_ptr, ptr0, len0);
        return ret;
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_sqlitewasmdatabase_new = function(arg0) {
        const ret = SQLiteWasmDatabase.__wrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sqlite_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
